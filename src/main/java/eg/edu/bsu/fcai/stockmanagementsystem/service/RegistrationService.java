...
public class RegistrationService {
    ...
    private User toUser(UserForm form, String id, String email, String phone, String password) {
        return User.builder().id(id).email(email).phone(phone).password(passwordEncoder.encode(password)).imageUrl(form.imageUrl()).nameArabic(form.nameArabic()).nameEnglish(form.nameEnglish()).isEnabled(false).isAccountNonLocked(true).isAccountNonExpired(true).isCredentialsNonExpired(true).build();
    }
